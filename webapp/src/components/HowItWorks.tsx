...
const Step = ({ number, title }: StepProps) => (
  <div className="relative text-center w-1/4">
    <div className="mx-auto w-12 h-12 bg-gray-800 border-2 border-gray-700 rounded-full flex items-center justify-center font-bold text-lg text-white">
      {number}
    </div>
  ...
  return (
    <section className="py-16 bg-black border-t border-b border-gray-800">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-12 text-white">Этапы организации мероприятия</h2>
