...
const ModelCard = ({ name, rating }: ModelCardProps) => (
  <div className="text-center">
    <div className="bg-gray-800 h-80 w-full rounded-lg mb-4 flex items-center justify-center">
  ...
  return (
    <section className="py-16 bg-black">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-2 text-white">Модели агентства XXX</h2>
        <p className="text-center text-gray-400 mb-12">Выберите ту, что украсит ваш вечер</p>
